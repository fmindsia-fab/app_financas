...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#f8fafc] flex flex-col">
      {/* Navbar */}
      <nav className="bg-[#0f172a] sticky top-0 z-50 border-b border-white/5">
      ...
      {/* Hero */}
      <section className="bg-[#0f172a] pt-24 pb-32 px-4 sm:px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-6 animate-fade-up">
            <Zap className="w-3 h-3" />
            Controle financeiro simplificado
          </div>

          <h1
            className="text-4xl sm:text-5xl md:text-6xl font-bold text-white leading-tight mb-6 animate-fade-up delay-100"
          ...
          <p className="text-slate-400 text-lg sm:text-xl max-w-2xl mx-auto mb-10 animate-fade-up delay-200">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center animate-fade-up delay-300">
            ...
            <Link
              href="/login"
              className="border border-white/10 hover:border-white/20 text-slate-300 hover:text-white font-medium px-8 py-3.5 rounded-xl text-base transition-all hover:bg-white/5 inline-block"
            >
              Já tenho conta
            </Link>
          </div>
          ...
          <div className="mt-16 animate-fade-up delay-400">
            <div className="bg-[#1e293b] border border-white/10 rounded-2xl p-4 max-w-2xl mx-auto shadow-2xl shadow-black/40">
                ...
                <div className="flex-1 space-y-2">
                  {[['Alimentação', '70%'], ['Transporte', '45%'], ['Moradia', '30%']].map(([cat, width]) => (
                    <div key={cat} className="flex items-center gap-2">
                      <div className="text-xs text-slate-400 w-24">{cat}</div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              {
                icon: Tags, color: 'bg-emerald-50 text-emerald-600',
              ...
              {
                icon: Download, color: 'bg-violet-50 text-violet-600',
                title: 'Exportar CSV',
              ...
              {
                icon: TrendingUp, color: 'bg-red-50 text-red-500',
              ...
              <div
                key={feature.title}
                className="group p-6 rounded-2xl border border-slate-100 hover:border-slate-200 hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
              >
                <div className={`w-12 h-12 rounded-xl ${feature.color} flex items-center justify-center mb-4`}>
                  <feature.icon className="w-5 h-5" />
                </div>
                <h3 className="font-bold text-slate-900 mb-2 text-lg" style={{ fontFamily: 'Bricolage Grotesque, sans-serif' }}>
                  {feature.title}
                </h3>
